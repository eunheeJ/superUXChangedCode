...
const CustomComponent = React.forwardRef(({ className, children, dummyData }, ref) => { const InfoBoxHead = (0,at_mui_material_5_15_2.styled)(at_mui_material_5_15_2.Typography) ` flex: 1; font-weight: 600; background: #f1f2f8; border: 1px solid #f8f8f8; padding: 10px; `; const InfoBoxBody = (0,at_mui_material_5_15_2.styled)(at_mui_material_5_15_2.Typography) ` flex: 1.5; border: 1px solid #f8f8f8; padding: 10px; `; const InfoBox = ({ title, value }) => (React.createElement(at_mui_material_5_15_2.Stack, { direction: 'row', flex: 1 }, React.createElement(InfoBoxHead, null, title), React.createElement(InfoBoxBody, null, value))); const InfoBoxList = ({ data }) => { const result = []; for (let i = 0; i < data.length; i += 4) { const title = data[i].value; const value = data[i + 1].value; const title2 = data[i + 2].value; const value2 = data[i + 3].value; result.push(React.createElement(at_mui_material_5_15_2.Stack, { direction: 'row', key: i }, React.createElement(InfoBox, { title: title, value: value }), React.createElement(InfoBox, { title: title2, value: value2 }))); } return React.createElement(React.Fragment, null, result); }; if (!dummyData) { return null; } return (React.createElement(at_mui_material_5_15_2.Box, null, React.createElement(InfoBoxList, { data: dummyData }))); });
